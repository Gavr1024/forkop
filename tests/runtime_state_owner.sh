...
grep -Fq 'Reload verification failed after sing-box was reloaded; restarting Forkop runtime' "$LIFECYCLE_UC" ||
  fail "service/lifecycle.uc must recover a failed sing-box reload through a full runtime restart"
